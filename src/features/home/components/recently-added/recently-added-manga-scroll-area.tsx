...
import { fetchRecentlyAddedMangas } from '@home/lib/recently-added/data';
import { Suspense } from 'react';

export async function RecentlyAddedMangaScrollArea() {
  return (
    <div>
...
async function ScrollArea() {
  const { data, error } = await fetchRecentlyAddedMangas();
  if (error) {
    return (
