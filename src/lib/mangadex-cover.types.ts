// To parse this data:
//
//   import { Convert, MangadexCover } from "./file";
//
//   const mangadexCover = Convert.toMangadexCover(json);
//
...
export class Convert {
  public static toMangadexCover(json: string): MangadexCover {
    return cast(JSON.parse(json), r('MangadexCover'));
  }

  public static mangadexCoverToJson(value: MangadexCover): string {
    return JSON.stringify(uncast(value, r('MangadexCover')), null, 2);
  }
}
